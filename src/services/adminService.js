...
import {findmany , save , findByEmail ,
     update , deleteById, findId , isExistAdmin, findByPassowrd } from "../repository/adminRepo.js"
...
export const saveAdmin = async(admin={})=>{
    ...
    const isAdminExist = await isExistAdmin(admin.email)
...
export const getAdminByPassword =async (password )=>{
  return await findByPassowrd(password)
}
